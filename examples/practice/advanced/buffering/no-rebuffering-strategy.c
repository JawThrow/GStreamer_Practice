...
static gboolean buffer_timeout(gpointer data)
{
	...
	query = gst_query_new_buffering(GST_FORMAT_TIME); // what is this function?
	...
	/* calculat the remaining playback time */
...
gint main(gint argc, gchar *argv[])
{
	...
	g_object_set(G_OBJECT(pipeline), "flags", 0x697, NULL); // what is flags and 0x697?
